========================================================================
    ACTIVE TEMPLATE LIBRARY : OPC_Server Project Overview
========================================================================

AppWizard has created this OPC_Server project for you to use as the starting point for
...
OPC_Server.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (OPC_Server.h)
        GUID definitions                                (OPC_Server_i.c)
        A type library                                  (OPC_Server.tlb)
        Marshaling code                                 (OPC_Server_p.c and dlldata.c)

OPC_Server.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in OPC_Server.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named OPC_Server.pch and a precompiled types file named StdAfx.obj.
...
OPC_Serverps.vcxproj
	...
	dlldata.c, OPC_Server_i.c and OPC_Server_p.c which are required
	to build the proxy/stub DLL.

OPC_Serverps.vcxproj.filters
