...
public:
    ...
    STDMETHOD(GenerateSignal)(DOUBLE* pdCurrentSignalValue, LONG nSignal);
private:
    //Signal Generate Function.
    double GenerateSignalY1(clock_t lCurrentRunTime);
    double GenerateSignalY2(clock_t lCurrentRunTime);
    double GenerateSignalY3(clock_t lCurrentRunTime);
};
